...
#  Script Name : put_event_workflow_started.py
#      Purpose : AWS Glue job to emit event that indicates:
#                workflow STARTED + workflow run id
...
args = getResolvedOptions(sys.argv,
                          ['WORKFLOW_NAME', 'WORKFLOW_RUN_ID', 'LOG_LEVEL'])
...
detail = json.dumps({'workflowName': workflow_name,
